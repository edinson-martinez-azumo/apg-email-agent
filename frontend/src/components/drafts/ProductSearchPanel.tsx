...
export function ProductSearchPanel({ onInsert, onRemove, editorReady, insertedSkus }: Props) {
      ...
      {insertedSkus.size > 0 && (
        <div className="px-3 py-2.5 border-b border-border shrink-0">
          <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2 flex items-center gap-1.5">
            In Draft
            <span className="rounded-full bg-primary/10 text-primary px-1.5 py-0.5 text-xs font-medium normal-case tracking-normal">
              {insertedSkus.size}
            </span>
          </p>
